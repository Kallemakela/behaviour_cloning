...
class TD3_BC(pl.LightningModule):
    def __init__(
        self,
        state_dim,
        action_dim,
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:  # Critic optimization
            with torch.no_grad():
            ...
            self.log("critic_loss", critic_loss, on_step=True, on_epoch=True)
            return critic_loss

        if optimizer_idx == 1:  # Actor optimization
            ...
            if self.total_it % self.policy_freq == 0:
                ...
                self.log("actor_loss", actor_loss, on_step=True, on_epoch=True)
